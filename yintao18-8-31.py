...
#week 1-7
week_count = [24, 32, 20, 16, 18, 17, 20]

#month 1703-.
month_count = [22, 17, 12, 9, 13, 9, 7, 5, 2, 5, 7, 5, 2, 3, 12, 8, 6, 3]
...
plt.title(r'20180831', fontproperties='SimHei', fontsize=15)
...
plt.ylabel('发微博天数', fontproperties='SimHei', fontsize=10)
plt.title('2018-08-31', fontproperties='SimHei', fontsize=15)
group_labels = ['17年03', '04', '05', '06', '07', '08', '09', '10', '11', '12', '01', '02', '03', '04', '05', '06', '07', '08']
